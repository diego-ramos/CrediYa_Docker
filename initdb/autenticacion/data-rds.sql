...
-- Volcando datos para la tabla crediya_authentication.permission: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla crediya_authentication.role: ~3 rows (aproximadamente)
DELETE FROM `role`;
...
-- Volcando datos para la tabla crediya_authentication.user: ~4 rows (aproximadamente)
DELETE FROM `user`;
INSERT INTO `user` (`idNumber`, `idType`, `firstNames`, `lastNames`, `email`, `phone`, `baseSalary`, `birthDate`, `address`, `roleId`, `password`) VALUES
	...
	(5566, 0, 'Diego A', 'Ramos P', 'diegoramos2000@hotmail.com', NULL, 10.000000, '1978-06-22', NULL, 0, '123');
